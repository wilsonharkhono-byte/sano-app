...
BEGIN
  ...
  -- ── Shared material catalog (clean, curated only) ────────────────────────
  ...
  VALUES
    ...
    ('AAC-BL75',  'Bata ringan 7.5 cm',           'Dinding',   2, 'pcs', 'pcs'),
    ('CEM-OPC50', 'Semen OPC 50 kg',              'Finishing', 2, 'zak', 'zak'),
    ('REB-D16',   'Besi ulir D16',                'Struktur',  1, 'kg',  'kg'),
    ('KRM-GR60',  'Keramik granit 60x60 cm',      'Finishing', 2, 'm2',  'm2'),
    ('PPR-34',    'Pipa PPR PN-10 3/4 inch',      'MEP',       2, 'm',   'm'),
  ...
  SELECT id INTO mat_aac    FROM material_catalog WHERE code = 'AAC-BL75';
  SELECT id INTO mat_cement FROM material_catalog WHERE code = 'CEM-OPC50';
  SELECT id INTO mat_rebar  FROM material_catalog WHERE code = 'REB-D16';
  SELECT id INTO mat_tile   FROM material_catalog WHERE code = 'KRM-GR60';
  SELECT id INTO mat_ppr    FROM material_catalog WHERE code = 'PPR-34';
  ...
  VALUES
    ...
    (pid_alpha, 'STR-02', 'Kolom Beton Bertulang',           'm3',   28.0,   8.0, 28.6, 'Ready mix kelas 30',      'Besi ulir D16'),
    ...
    (pid_alpha, 'FIN-02', 'Pemasangan Keramik Lantai 60x60', 'm2',  210.0,  45.0, 21.4, 'Keramik granit 60x60 cm', NULL),
    (pid_alpha, 'MEP-01', 'Instalasi Pipa Air Bersih',       'm',   180.0, 120.0, 66.7, 'Pipa PPR PN-10 3/4 inch', NULL),
    (pid_alpha, 'ARC-02', 'Pemasangan Kusen Aluminium',      'unit',  24.0,   8.0, 33.3, 'Kusen aluminium 4 inch', NULL),
    (pid_alpha, 'STR-03', 'Balok Beton Bertulang Lt.1',      'm3',   18.0,   5.5, 30.6, 'Ready mix kelas 30',      'Besi ulir D16');
  ...
  VALUES
    (pid_beta, 'STR-01', 'Pekerjaan Pondasi Tapak',          'm3',  32.0,  0.0, 0.0, 'Ready mix kelas 25',      'Besi ulir D16'),
    (pid_beta, 'ARC-01', 'Pasangan Dinding Bata Ringan',     'm2', 280.0,  0.0, 0.0, 'Bata ringan 7.5 cm',      NULL),
    (pid_beta, 'FIN-01', 'Pemasangan Keramik Lantai 60x60',  'm2', 165.0,  0.0, 0.0, 'Keramik granit 60x60 cm', NULL),
    (pid_beta, 'MEP-01', 'Instalasi Pipa Air Bersih',        'm',  150.0,  0.0, 0.0, 'Pipa PPR PN-10 3/4 inch', NULL);
  ...
  VALUES
    ...
    (pid_alpha, 'PO-ALPHA-003', 'FIN-02', 'CV Keramik Indah',   'Keramik granit 60x60 cm', 210.0, 'm2',  185000, '2026-03-20', 'FULLY_RECEIVED'),
    (pid_alpha, 'PO-ALPHA-004', 'MEP-01', 'Toko Sanitasi Jaya', 'Pipa PPR PN-10 3/4 inch', 180.0, 'm',    28000, '2026-04-01', 'PARTIAL_RECEIVED');
  ...
  VALUES
    ...
    (po_alpha_3, mat_tile,  'Keramik granit 60x60 cm', 210.0, 'm2',  185000),
    (po_alpha_4, mat_ppr,   'Pipa PPR PN-10 3/4 inch', 180.0, 'm',    28000);
  ...
  JOIN (
    VALUES
      ...
      (po_alpha_3, 'Keramik granit 60x60 cm', 210.0::numeric,'m2', '2026-03-20T10:50:00+07'::timestamptz),
      (po_alpha_4, 'Pipa PPR PN-10 3/4 inch', 120.0::numeric,'m',  '2026-04-01T14:10:00+07'::timestamptz)
